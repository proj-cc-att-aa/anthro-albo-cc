# ================== Counterfactual temperature extraction from NetCDF to CSV ==================
...
for(year in 2001:2021){
  ...
  nc_file_path <- paste0("Netcdf_file/20crv3-era5_counterclim_tas_celsius_global_daily_", year, ".nc")
...
year = 2004
nc_file_path <- paste0("GFDL_model/Netcdf_file/Global_pi_control_GFDL_Tmean_°C_", year, ".nc")
rast_file <- rast(nc_file_path)
plot(rast_file)
